...
- `releaseMatrixGate -PmagSmokeSeconds=5`: passed all 22 isolated profiles on 2026-08-14 in 8m21s, including the minimal release profile, absent-mod behavior, Coasters Simulated: Track Styles, Steam 'n' Rails, Copycats+, TFMG, both Ore Excavation integrations, and Curios.
