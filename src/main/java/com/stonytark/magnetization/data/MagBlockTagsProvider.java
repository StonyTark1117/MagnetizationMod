...
public final class MagBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(final HolderLookup.Provider provider) {
        ...
        tag(BlockTags.NEEDS_STONE_TOOL)
                ...
                .add(MagBlocks.RAW_LITHIUM_BLOCK.get())
                .add(MagBlocks.RAW_GALLIUM_BLOCK.get());
        ...
        tag(BlockTags.NEEDS_IRON_TOOL)
                ...
                .add(MagBlocks.FERROMAGNETIC_BLOCK.get())
                ...
                .add(MagBlocks.BASTNASITE_ORE.get()).add(MagBlocks.DEEPSLATE_BASTNASITE_ORE.get())
