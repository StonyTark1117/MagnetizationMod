...
- **Air Separator** — a Create-kinetic machine that simultaneously produces five atmospheric fractions into face-isolated output tanks. Connect Create fluid pipes to the assigned faces to extract the individual gases; its dedicated GUI shows all tank levels, live rates, RPM/status, isotope progress, and clickable face assignments alongside module/output slots. Create goggles, Jade, WTHIT, and The One Probe show the compact live summary.
