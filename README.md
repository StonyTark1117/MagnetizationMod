...
- [Create Crafts & Additions](https://www.curseforge.com/minecraft/mc-mods/createaddition) — its Alternator, Electric Motor, Rolling Mill, Tesla Coil, and iron electrical parts receive magnetic/conductive roles. Its standard FE sources power Magnetization emitters directly, and native Create-goggle/Ponder support remains authoritative. Verified against published 1.6.0.
...
- [Create: Diesel Generators](https://www.curseforge.com/minecraft/mc-mods/create-diesel-generators) — compact, modular, and huge engines retain their native Create kinetic/goggle behavior and their structural metal contributes ship susceptibility. Tanks, fermenters, barrels, canisters, fuel-fluid blocks, burners, and encased fluid pipes are explicitly excluded so contents are never mistaken for structural magnetic material. Verified against 1.21.1-1.3.15.
...
- [Create: Ender Transmission](https://www.curseforge.com/minecraft/mc-mods/create-ender-transmission) — its Energy Transmitter carries **Create kinetic rotation**, not NeoForge FE; Magnetization works through that native kinetic contract and its normal FE inputs remain independently capability-compatible. The published remote-channel link and powered chunk-loader ticket lifecycle are covered by an isolated GameTest against 2.1.1.
