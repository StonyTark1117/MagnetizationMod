...
Current release: **1.4.3**. This hotfix makes the 1.4.2 compatibility work load with the older AeroPortals, JEI, and Coasters Simulated builds used by supported packs, and formally covers the two reported mounted-Railgun failures. Every bridge still targets the individual addon rather than a particular modpack.
