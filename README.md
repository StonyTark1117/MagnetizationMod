...
- [Create Ore Excavation](https://www.curseforge.com/minecraft/mc-mods/create-ore-excavation) — adds condition-gated infinite-vein recipes for Magnetite, Maghemite, Pyrrhotite, Hematite, Titanomagnetite, Lithium, and Helium-3. The recipes remain absent when the addon or shared Ore Excavation compatibility setting is disabled.
